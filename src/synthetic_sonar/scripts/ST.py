#!/usr/bin/env python3
# make sure to choose Scenario 1
import numpy as np
...
class TabbedApp:
    ...
    def sonar_update(self):
        ...
        for topic in self.sonar_subscriber.sonar_topics:
            ...
            ekf_map.Sigma =Sigma_sparse - Sigma_sparse.dot(ekf_map.K.dot(H_sparse))#I_minus_KH_sparse.dot(Sigma_sparse)
